...
* [Lockerz Share](http://share.lockerz.com/)

== Installation ==

1. Unzip the open-graph-protocol.zip folder
1. Upload the open-graph-protocol folder to your /wp-content/plugins directory
